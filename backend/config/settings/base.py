...
PAYMENT_EXPIRATION_SCHEDULE_MINUTES = env_int("PAYMENT_EXPIRATION_SCHEDULE_MINUTES", 5)
CART_GUEST_TTL_HOURS = env_int("CART_GUEST_TTL_HOURS", 72)
CART_CLEANUP_BATCH_SIZE = env_int("CART_CLEANUP_BATCH_SIZE", 200)
GUEST_CART_CLEANUP_SCHEDULE_MINUTES = env_int("GUEST_CART_CLEANUP_SCHEDULE_MINUTES", 60)
CELERY_BEAT_SCHEDULE = {
    "payments.expire_stale_payment_sessions": {
        "task": "payments.expire_stale_payment_sessions",
        "schedule": timedelta(minutes=PAYMENT_EXPIRATION_SCHEDULE_MINUTES),
    },
    "cart.cleanup_expired_guest_carts": {
        "task": "cart.cleanup_expired_guest_carts",
        "schedule": timedelta(minutes=GUEST_CART_CLEANUP_SCHEDULE_MINUTES),
    },
}
...
PRIVACY_POLICY_VERSION = env_value("PRIVACY_POLICY_VERSION", "2026-05")
OFFER_AGREEMENT_VERSION = env_value("OFFER_AGREEMENT_VERSION", "2026-05")
MARKETING_CONSENT_VERSION = env_value("MARKETING_CONSENT_VERSION", "2026-05")
AVATAR_UPLOAD_MAX_BYTES = env_int("AVATAR_UPLOAD_MAX_BYTES", 2 * 1024 * 1024)
PRODUCT_IMAGE_UPLOAD_MAX_BYTES = env_int(
    "PRODUCT_IMAGE_UPLOAD_MAX_BYTES", 8 * 1024 * 1024
)
IMAGE_UPLOAD_MAX_PIXELS = env_int("IMAGE_UPLOAD_MAX_PIXELS", 16_000_000)
